...
public class ProducerMetrics {
    ...
    public <T> void registerAckAllTotalBytesGauge(
        ...
        gaugeRegistrar.registerGauge(
                ACK_ALL_BUFFER_TOTAL_BYTES, stateObj, f, tags(sender, datacenter));
    }
    ...
    public <T> void registerAckAllCompressionRateGauge(
            T stateObj, ToDoubleFunction<T> f, String sender, String datacenter) {
        gaugeRegistrar.registerGauge(
                ACK_ALL_COMPRESSION_RATE, stateObj, f, tags(sender, datacenter));
    }
    ...
    private static final String ACK_ALL_RECORD_SEND_TOTAL =
            KAFKA_PRODUCER + ACK_ALL + "record-send";
