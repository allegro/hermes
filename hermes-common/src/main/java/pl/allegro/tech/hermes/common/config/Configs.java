...
public enum Configs {
    ...
    PUBSUB_SENDER_CORE_POOL_SIZE("pubsub.sender.core.pool.size", 4),
    PUBSUB_SENDER_RETRY_DELAY("pubsub.sender.retry.delay.ms", 100L),
    PUBSUB_SENDER_RETRY_DELAY_MULTIPLIER("pubsub.sender.retry.delay.multiplier", 2.0d),
    PUBSUB_SENDER_MAX_RETRY_DELAY("pubsub.sender.max.retry.delay.ms", 60_000L),
    PUBSUB_SENDER_INITIAL_RPC_TIMEOUT("pubsub.sender.initial.rpc.timeout.ms", 10_000L),
    PUBSUB_SENDER_RPC_TIMEOUT_MULTIPLIER("pubsub.sender.rpc.timeout.multiplier", 1.5d),
    PUBSUB_SENDER_MAX_RPC_TIMEOUT("pubsub.sender.max.rpc.timeout.ms", 600_000L),
    PUBSUB_SENDER_TOTAL_TIMEOUT("pubsub.sender.total.timeout.ms", 600_000L),
    PUBSUB_SENDER_REQUEST_BYTES_THRESHOLD("pubsub.sender.request.bytes.threshold", 1L),
    PUBSUB_SENDER_MESSAGE_COUNT_BATCH_SIZE("pubsub.sender.message.count.bytes.size", 1L),
    PUBSUB_SENDER_PUBLISH_DELAY_THRESHOLD("pubsub.sender.publish.delay.threshold.ms", 1L),
    PUBSUB_HEADER_NAME_TOPIC_NAME("pubsub.header.name.topic.name", "tn"),
    PUBSUB_HEADER_NAME_MESSAGE_ID("pubsub.header.name.message.id", "id"),
    PUBSUB_HEADER_NAME_TIMESTAMP("pubsub.header.name.timestamp", "ts"),
    PUBSUB_HEADER_NAME_SCHEMA_VERSION("pubsub.header.name.schema.version", "sv"),
    PUBSUB_HEADER_NAME_SCHEMA_ID("pubsub.header.name.schema.id", "sid"),
