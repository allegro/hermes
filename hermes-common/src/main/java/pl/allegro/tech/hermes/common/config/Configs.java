...
public enum Configs {
    ...
    SCHEMA_REPOSITORY_SUBJECT_SUFFIX_ENABLED("schema.repository.subjectSuffixEnabled", false),
    SCHEMA_REPOSITORY_SUBJECT_NAMESPACE_ENABLED("schema.repository.subjectNamespaceEnabled", false),
