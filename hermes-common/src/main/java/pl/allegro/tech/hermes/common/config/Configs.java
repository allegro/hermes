...
public enum Configs {
    ...
    GOOGLE_PUBSUB_PUBLISHERS_CACHE_SIZE("googlepubsub.publishers.cache.size", 1000L),
    GOOGLE_PUBSUB_PUBLISHERS_CACHE_EXPIRE_AFTER_ACCESS_SECONDS("googlepubsub.publishers.expire.after.access.seconds", 86400L),
