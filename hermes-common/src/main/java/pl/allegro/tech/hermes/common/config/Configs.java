...
public enum Configs {
    ...
    FRONTEND_SSL_KEYSTORE_PROVIDED("frontend.ssl.keystore.provided", false),
    ...
    FRONTEND_SSL_TRUSTSTORE_DEFAULT_JVM("frontend.ssl.truststore.default.jvm", true),
    FRONTEND_SSL_TRUSTSTORE_PROVIDED("frontend.ssl.truststore.provided", false),
    ...
    CONSUMER_SSL_PROTOCOL("consumer.ssl.protocol", "TLSv1.2"),

    CONSUMER_SSL_KEYSTORE_DEFAULT_JVM("consumer.ssl.keystore.default.jvm", true),
    CONSUMER_SSL_KEYSTORE_PROVIDED("consumer.ssl.keystore.provided", false),
    ...
    CONSUMER_SSL_TRUSTSTORE_DEFAULT_JVM("consumer.ssl.truststore.default.jvm", true),
    CONSUMER_SSL_TRUSTSTORE_PROVIDED("consumer.ssl.truststore.provided", false),
