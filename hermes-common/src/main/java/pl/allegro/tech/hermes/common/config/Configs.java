...
public enum Configs {
    ...
    FRONTEND_TOPIC_METADATA_LOADING_JOB_ENABLED("frontend.startup.topic.metadata.job.enabled", false),
    FRONTEND_TOPIC_METADATA_LOADING_JOB_INTERVAL("frontend.startup.topic.metadata.job.interval", 60),
