...
public class AvroMessageSchemaVersionTruncationContentWrapper
    ...
    public AvroMessageContentUnwrapperResult unwrap(
        ...
        try {
            ...
            byte[] dataWithoutMagicByteAndSchemaId =
                    SchemaAwareSerDe.trimMagicByteAndSchemaVersion(data);
            ...
            return AvroMessageContentUnwrapperResult.success(
                    avroMessageContentWrapper.unwrapContent(
                            dataWithoutMagicByteAndSchemaId, avroSchema));
        } catch (Exception e) {
            logger.warn(
    ...
    private boolean containsSchemaVersionInMagicByteAndInHeader(
            byte[] data, Integer schemaVersion) {
