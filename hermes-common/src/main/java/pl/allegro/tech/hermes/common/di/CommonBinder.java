...
import pl.allegro.tech.hermes.common.schema.SchemaRegistryClientFactory;
import pl.allegro.tech.hermes.common.schema.SchemaRegistryInstanceResolverFactory;
...
public class CommonBinder extends AbstractBinder {
    ...
    protected void configure() {
        ...
        bindSingletonFactory(SchemaRegistryClientFactory.class);
        bindSingletonFactory(SchemaRegistryInstanceResolverFactory.class);
