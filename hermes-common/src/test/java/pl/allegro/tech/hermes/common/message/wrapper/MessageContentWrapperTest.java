...
public class MessageContentWrapperTest {
                ...
                public SchemaVersionsResult versions(Topic topic, boolean online) {
                    List<SchemaVersion> onlineVersions =
                            asList(
                                    ...
                                    schema2.getVersion(),
                                    schema1.getVersion());
                    List<SchemaVersion> cachedVersions =
    ...
    public void shouldUnwrapMessageUsingSchemaIdFromPayload() {
        ...
        // then
        assertResult(
                unwrappedMessageContent, schemaId, user.asBytes(), messageId, messageTimestamp);
    ...
    public void shouldTrimSchemaVersionFromMessageWhenSchemaVersionPresentInHeader() {
        ...
        UnwrappedMessageContent unwrappedMessageContent =
                compositeMessageContentWrapper.unwrapAvro(
                        wrapped, topic, NO_ID_IN_HEADER, VERSION_ONE);
    ...
    private void assertMetrics(
        ...
        assertThat(
                        meterRegistryCounterValue(
                                basePath + ".errors",
                                Tags.of("deserialization_type", "payloadWithSchemaId")))
                .isEqualTo(errorsForPayloadWithSchemaId);

        assertThat(
                        meterRegistryCounterValue(
                                basePath + ".errors",
                                Tags.of("deserialization_type", "headerSchemaVersion")))
                .isEqualTo(errorsForHeaderSchemaVersion);

        assertThat(
                        meterRegistryCounterValue(
                                basePath + ".errors",
                                Tags.of("deserialization_type", "headerSchemaId")))
                .isEqualTo(errorsForHeaderSchemaId);

        assertThat(
                        meterRegistryCounterValue(
                                basePath + ".errors",
                                Tags.of("deserialization_type", "schemaVersionTruncation")))
        ...
        assertThat(
                        meterRegistryCounterValue(
                                basePath, Tags.of("deserialization_type", "headerSchemaId")))
