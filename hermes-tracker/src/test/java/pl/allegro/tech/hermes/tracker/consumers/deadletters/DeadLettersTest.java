...
public class DeadLettersTest {
    ...
    public void testDeadLettersWhenEmpty() {
        // Given
        Subscription subscription = SubscriptionBuilder.subscription("pl.allegro.group.topic", "subscription").build();
    ...
    public void testDeadLettersWhenRepoAreMixed() {
        ...
        DeadLetters deadLetters = new DeadLetters(List.of(supportingRepository, notSupportingRepository));
