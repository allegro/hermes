...
public class GoogleBigQueryAvroDataWriter extends GoogleBigQueryDataWriter<GenericRecord, SchemaAwareStreamWriter<GenericRecord>, GoogleBigQueryAvroStreamWriterFactory> {


    public GoogleBigQueryAvroDataWriter(String streamName, GoogleBigQueryAvroStreamWriterFactory factory) {
        super(streamName, factory);
    }

    @Override
    protected ApiFuture<AppendRowsResponse> append(GenericRecord message) throws Descriptors.DescriptorValidationException, IOException {
