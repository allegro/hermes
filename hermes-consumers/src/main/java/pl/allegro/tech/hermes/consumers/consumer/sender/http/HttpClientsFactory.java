...
public class HttpClientsFactory {
    ...
    public HttpClient createClientForHttp1(
            String name, Http1ClientParameters http1ClientParameters) {
        ...
        client.setMaxConnectionsPerDestination(
                http1ClientParameters.getMaxConnectionsPerDestination());
    ...
    public HttpClient createClientForHttp2(
            String name, Http2ClientParameters http2ClientParameters) {
        ClientConnector clientConnector = new ClientConnector();
        sslContextFactoryProvider
                .provideSslContextFactory()
                .ifPresentOrElse(
