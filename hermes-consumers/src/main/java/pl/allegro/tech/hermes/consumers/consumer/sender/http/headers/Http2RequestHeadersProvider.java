...
public final class Http2RequestHeadersProvider implements HttpRequestHeadersProvider {
    ...
    public Http2RequestHeadersProvider(Optional<HttpAuthorizationProvider> authorizationProvider) {
    ...
    public HttpRequestHeaders getHeaders(Message message) {
        ...
        builder.put(HttpHeader.CONTENT_TYPE.toString(), contentTypeToMediaType.apply(message.getContentType()));
