...
public class MaxRateRegistry implements NodeCacheListener {
    ...
    public MaxRateRegistry(
        ...
        this.maxRateNodeCache =
                new NodeCache(curator, registryPaths.consumerMaxRatePath(consumerId));
        ...
        zookeeper
                ...
                .ifPresent(
                        maxRates -> {
                            ...
                            maxRates.cleanup(
                                    clusterAssignmentCache.getConsumerSubscriptions(consumerId));
                            ...
                            if (decodedSize > cleanedSize) {
                                ...
                                logger.debug(
                                        "Refreshed max rates of {} with {} subscriptions",
                                        consumerId,
                                        cleanedSize);
                            }
    ...
    public void onAfterWriteRateHistories() {
        ...
        try {
            zookeeper.writeOrCreatePersistent(
                    registryPaths.currentConsumerRateHistoryPath(), encoded);
        } catch (Exception e) {
