...
public interface ConsumerProfiler {
    ...
    /**
     * Measures the execution time of a specific piece of code. The measurement starts with a call
     * to this method, and is terminated by another call to the same method with a different
     * parameter (to keep the measurement continuity), or by calling the <code>flushMeasurements
     * </code> method.
     */
