...
class Http2RequestHeadersProviderTest extends Specification {
    ...
    HttpRequestHeadersProvider requestHeadersProvider = new Http2RequestHeadersProvider(new Http1RequestHeadersProvider(Optional.empty()))
    HttpRequestHeadersProvider requestHeadersProviderWithAuthorization = new Http2RequestHeadersProvider(new Http1RequestHeadersProvider(Optional.of(authorizationProvider)))
