...
import pl.allegro.tech.hermes.consumers.consumer.converter.DefaultMessageConverter;
...
public class ConsumerTest {
    ...
    public void setUp() throws Exception {
        ...
        consumer = spy(new Consumer(messageReceiver, hermesMetrics, SUBSCRIPTION,
                consumerRateLimiter, partitionOffsetHelper, sender, infligtSemaphore, trackers, new DefaultMessageConverter()));
    }
