...
public class BackupMessagesLoader {
    ...
    public BackupMessagesLoader(BrokerTopicMetadataFetcher brokerTopicMetadataFetcher,
    ...
    private boolean isBrokerTopicAvailable(CachedTopic cachedTopic) {
        ...
        if (brokerTopicMetadataFetcher.tryFetchFromLocalDatacenter(cachedTopic)) {
