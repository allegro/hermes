...
public class PublishingServlet extends HttpServlet {
    ...
    private void handlePublishAsynchronously(HttpServletRequest request, HttpServletResponse response, Topic topic, String messageId)
        ...
        asyncContext.addListener(new TimeoutAsyncListener(httpResponder, messageState, requestTimeoutLock));
                    ...
                    try {
                        ...
                        messagePublisher.publish(message, topic, messageState, requestTimeoutLock,
                                ...
                                new AsyncContextExecutionCallback(asyncContext,
                                        ...
                                        new HttpPublishingCallback(httpResponder, requestTimeoutLock),
