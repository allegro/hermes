...
public class KafkaMessageSendersFactory {
    ...
    public KafkaMessageSendersFactory(
        ...
        this.topicMetadataLoadingExecutor =
                new TopicMetadataLoadingExecutor(
                        topicsCache, retryCount, retryInterval, threadPoolSize);
    ...
    private KafkaMessageSender<byte[], byte[]> sender(
        ...
        props.put(
                ...
                (int) kafkaProducerParameters.getRequestTimeout().toMillis());
        props.put(
                DELIVERY_TIMEOUT_MS_CONFIG,
                (int) kafkaProducerParameters.getDeliveryTimeout().toMillis());
        ...
        props.put(
                ...
                (int) kafkaProducerParameters.getRetryBackoff().toMillis());
        props.put(
                METADATA_MAX_AGE_CONFIG,
                (int) kafkaProducerParameters.getMetadataMaxAge().toMillis());
        props.put(
