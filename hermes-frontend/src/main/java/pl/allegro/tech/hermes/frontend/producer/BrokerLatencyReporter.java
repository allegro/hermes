    ...
    public void report(
        ...
        if (perBrokerLatencyEnabled) {
            try {
                ...
                // don't propagate the exception - allow metrics to be dropped if executor is
                // overloaded
                // executor service should already be instrumented to meter rejected executions so
                // no action is needed
            }
        }
    }
