...
class CachedTopicsTestHelper {
    ...
    static ThroughputRegistry registry = new ThroughputRegistry(micrometerHermesMetrics, new MetricRegistry())
    ...
    static CachedTopic cachedTopic(String name) {
        ...
        return new CachedTopic(TopicBuilder.topic(name).build(), micrometerHermesMetrics, registry, kafkaTopics)
    }
    ...
    static CachedTopic cachedTopic(Topic topic) {
        ...
        return new CachedTopic(topic, micrometerHermesMetrics, registry, kafkaTopics)
    }
}
