...
.. code-block:: bash
    ...
    curl -d '{"name": "clicks-receiver", "endpoint": "http://requestb.in/1isy54g1"}' -H "Content-Type: application/json" -H "Hermes-Group-Password: passwd" http://192.168.59.103:8080/topics/com.example.events.clicks/subscriptions
