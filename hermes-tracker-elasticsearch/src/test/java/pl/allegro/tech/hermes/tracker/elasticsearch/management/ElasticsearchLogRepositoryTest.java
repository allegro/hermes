...
public class ElasticsearchLogRepositoryTest implements LogSchemaAware {
    ...
    public void setUp() {
        ...
        consumersLogRepository =
                new ConsumersElasticsearchLogRepository.Builder(
                                elasticsearch.client(), metricsFacade)
    ...
    public void shouldGetLastUndelivered() throws Exception {
        ...
        // difference between first and second timestamp must be bigger than 1000ms as query sorts
        // by seconds
    ...
    public void shouldGetMessageStatus() {
        ...
        assertThat(fetchMessageStatus(messageMetadata))
                ...
                .contains(
                        sentMessageTrace(
                                messageMetadata, timestamp, SentMessageTraceStatus.SUCCESS));
    }
