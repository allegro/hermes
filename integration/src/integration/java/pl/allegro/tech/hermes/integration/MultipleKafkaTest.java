...
public class MultipleKafkaTest extends IntegrationTest {
    ...
    private ConsumersStarter setupConsumers() throws Exception {
        ...
        consumers.overrideProperty(Configs.KAFKA_BROKER_LIST, kafkaClusterTwo.getBootstrapServers());
    ...
    private FrontendStarter setupFrontend() throws Exception {
        ...
        frontend.overrideProperty(Configs.KAFKA_BROKER_LIST, kafkaClusterTwo.getBootstrapServers());
