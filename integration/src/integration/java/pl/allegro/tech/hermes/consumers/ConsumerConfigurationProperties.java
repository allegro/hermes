...
public class ConsumerConfigurationProperties {
    ...
    public static String KAFKA_CONSUMER_RECONNECT_BACKOFF_MS_CONFIG = "consumer.kafka.consumer.reconnect.backoff.ms";
    public static String KAFKA_CONSUMER_RETRY_BACKOFF_MS_CONFIG = "consumer.kafka.consumer.retry.backoff.ms";
    public static String KAFKA_CONSUMER_REQUEST_TIMEOUT_MS_CONFIG = "consumer.kafka.consumer.request.timeout.ms";
    public static String KAFKA_CONSUMER_MAX_POLL_RECORDS_CONFIG = "consumer.kafka.consumer.max.poll.records";
    public static String KAFKA_CONSUMER_AUTO_OFFSET_RESET_CONFIG = "consumer.kafka.consumer.auto.offset.reset";
    public static String KAFKA_CONSUMER_SESSION_TIMEOUT_MS_CONFIG = "consumer.kafka.consumer.session.timeout.ms";
    public static String KAFKA_CONSUMER_HEARTBEAT_INTERVAL_MS_CONFIG = "consumer.kafka.consumer.heartbeat.interval.ms";
    public static String KAFKA_CLUSTER_NAME = "consumer.kafka.clusterName";
    ...
    public static String ZOOKEEPER_CONNECTION_STRING = "consumer.zookeeper.connectionString";
    public static String KAFKA_AUTHORIZATION_ENABLED = "consumer.kafka.authorization.enabled";
    public static String KAFKA_BROKER_LIST = "consumer.kafka.brokerList";
}
