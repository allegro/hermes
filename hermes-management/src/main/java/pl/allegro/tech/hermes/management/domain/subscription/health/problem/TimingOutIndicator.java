...
public class TimingOutIndicator implements SubscriptionHealthProblemIndicator {
    ...
    public TimingOutIndicator(
            double maxTimeoutsRatio, double minSubscriptionRateForReliableMetrics) {
    ...
    private boolean isTimeoutsRateHigh(SubscriptionHealthContext context) {
        ...
        return timeoutsRate
                > maxTimeoutsRatio * context.getSubscriptionRateRespectingDeliveryType();
    }
}
