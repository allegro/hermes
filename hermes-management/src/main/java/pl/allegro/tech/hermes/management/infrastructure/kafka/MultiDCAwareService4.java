...
public class MultiDCAwareService4 {

    private static final Logger logger = LoggerFactory.getLogger(MultiDCAwareService4.class);

    private final ClustersProvider4 clustersProvider;
    ...
    public MultiDCAwareService4(ClustersProvider4 clustersProvider, Clock clock,
