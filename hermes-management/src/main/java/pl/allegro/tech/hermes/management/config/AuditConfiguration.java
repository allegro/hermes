...
public class AuditConfiguration {
  ...
  @Bean
  @ConditionalOnProperty(prefix = "management.audit", value = "isLoggingAuditEnabled", havingValue = "true")
  public LoggingAuditor loggingAuditor(ObjectMapper objectMapper) {
    return new LoggingAuditor(javers(), objectMapper);
  }

  @Bean
  @ConditionalOnProperty(prefix = "management.audit", value = "isEventAuditEnabled", havingValue = "true")
