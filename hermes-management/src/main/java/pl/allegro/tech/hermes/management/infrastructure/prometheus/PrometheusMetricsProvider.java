...
public class PrometheusMetricsProvider
    ...
    public PrometheusMetricsProvider(
        ...
        this.frontendMetricsPrefix =
                frontendMetricsPrefix.isEmpty() ? "" : frontendMetricsPrefix + "_";
    ...
    public MonitoringSubscriptionMetrics subscriptionMetrics(SubscriptionName subscriptionName) {
        ...
        String subscriptionTimeoutsQuery =
                forSubscription(
                        consumerMetricName(SUBSCRIPTION_TIMEOUTS),
                        subscriptionName,
                        additionalFilters);
        String subscriptionThroughputQuery =
                forSubscription(
                        consumerMetricName(SUBSCRIPTION_THROUGHPUT),
                        subscriptionName,
                        additionalFilters);
        String subscriptionOtherErrorsQuery =
                forSubscription(
                        consumerMetricName(SUBSCRIPTION_OTHER_ERRORS),
                        subscriptionName,
                        additionalFilters);
        String subscriptionBatchesQuery =
                forSubscription(
                        consumerMetricName(SUBSCRIPTION_BATCHES),
                        subscriptionName,
                        additionalFilters);
        String subscriptionRetriesQuery =
                forSubscription(
                        consumerMetricName(SUBSCRIPTION_RETRIES),
                        subscriptionName,
                        additionalFilters);
        ...
        return MonitoringSubscriptionMetricsProvider.metricsBuilder()
                ...
                .withOtherErrors(
                        prometheusMetricsContainer.metricValue(subscriptionOtherErrorsQuery))
                .withMetricPathBatchRate(
                        prometheusMetricsContainer.metricValue(subscriptionBatchesQuery))
    ...
    public MonitoringTopicMetrics topicMetrics(TopicName topicName) {
        String topicRateQuery =
                forTopic(frontendMetricName(TOPIC_RATE), topicName, additionalFilters);
