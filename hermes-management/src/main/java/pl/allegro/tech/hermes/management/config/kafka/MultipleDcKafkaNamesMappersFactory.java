 ...
 *
 * @deprecated TODO: Remove this class after JsonToAvro topic migration feature will be removed from the codebase.
 *             We can simplify it and use a single KafkaNamesMapper across entire hermes-management instead of multiple mappers per DC.
 */
