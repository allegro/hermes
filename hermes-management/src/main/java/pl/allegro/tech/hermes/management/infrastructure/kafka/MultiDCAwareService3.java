...
public class MultiDCAwareService3 {

    private static final Logger logger = LoggerFactory.getLogger(MultiDCAwareService3.class);

    private final ClustersProvider3 clustersProvider;
    ...
    public MultiDCAwareService3(ClustersProvider3 clustersProvider, Clock clock,
