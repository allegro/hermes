...
public class TopicService {
    ...
    public void createTopic(Topic topic) {
        if (Topic.ContentType.AVRO == topic.getContentType() || !isNullOrEmpty(topic.getMessageSchema())) {
    ...
    public void updateTopic(Topic topic) {
        ...
        if (!retrieved.equals(modified)) {
            if (Topic.ContentType.AVRO == topic.getContentType() || !isNullOrEmpty(modified.getMessageSchema())) {
