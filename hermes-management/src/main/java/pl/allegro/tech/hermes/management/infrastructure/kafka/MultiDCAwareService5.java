...
public class MultiDCAwareService5 {

    private static final Logger logger = LoggerFactory.getLogger(MultiDCAwareService5.class);

    private final ClustersProvider5 clustersProvider;
    ...
    public MultiDCAwareService5(ClustersProvider5 clustersProvider, Clock clock,
