...
public class HybridTopicMetricsRepository implements TopicMetricsRepository {
    ...
    public HybridTopicMetricsRepository(MonitoringTopicMetricsProvider monitoringTopicMetricsProvider,
    ...
    public TopicMetrics loadMetrics(TopicName topicName) {
        MonitoringTopicMetricsProvider.MonitoringTopicMetrics metrics = monitoringTopicMetricsProvider.topicMetrics(topicName);
