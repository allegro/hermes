...
public class ConsoleConfiguration {
    ...
    FilterRegistrationBean<FrontendRoutesFilter> frontendRoutesFilter() {
        FilterRegistrationBean<FrontendRoutesFilter> registrationBean =
    ...
    ConsoleConfigurationRepository consoleConfigurationRepository(
        ...
        switch (properties.getType()) {
            ...
            case SPRING_CONFIG:
                return new SpringConfigConsoleConfigurationRepository(
                        objectMapper, consoleProperties);
            default:
    ...
    private ConsoleConfigurationRepository httpConsoleConfigurationRepository(
        ...
        var socketConfig =
                SocketConfig.custom()
                        .setSoTimeout(
                                (int) httpClientProperties.getReadTimeout().toMillis(),
