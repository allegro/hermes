                ...
                DistributedAtomicLong distributedAtomicLong =
                        new DistributedAtomicLong(
                                ...
                                new ExponentialBackoffRetry(
                                        distributedLoaderBackoff, distributedLoaderRetries));
                counterPerDatacenter.put(
                        zookeeperClient.getDatacenterName(), distributedAtomicLong);
            }
        }
        ...
        private void ensureConnected(String datacenter) {
            ...
            if (!curator.getZookeeperClient().isConnected()) {
                throw new ZookeeperCounterException(
                        counterName,
                        "Could not establish connection to a Zookeeper instance in "
                                + datacenter
                                + ".");
            }
        }
