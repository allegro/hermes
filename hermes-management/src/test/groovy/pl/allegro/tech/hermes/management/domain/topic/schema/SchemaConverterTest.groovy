...
class SchemaConverterTest extends Specification {
    ...
    def "should convert valid AVRO IDL to AVRO Schema"() {
        ...
        String expectedSchema = "{\"type\":\"record\",\"name\":\"TopicA\",\"namespace\":\"pl.local\",\"fields\":[{\"name\":\"__metadata\",\"type\":[\"null\",{\"type\":\"map\",\"values\":\"string\"}],\"default\":null},{\"name\":\"nestedObject\",\"type\":{\"type\":\"record\",\"name\":\"NestedObject\",\"fields\":[{\"name\":\"id\",\"type\":\"string\"},{\"name\":\"field1\",\"type\":\"string\"},{\"name\":\"field2\",\"type\":\"string\"}]}}]}"
