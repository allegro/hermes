...
public class TopicBlacklistTest {
    ...
    public void shouldBlacklistNonExistingTopic() {
        // expect
        WebTestClient.ResponseSpec response =
                hermes.api().blacklistTopicResponse("nonExisting.topic");
    ...
    public void shouldUnBlacklistTopic() {
        ...
        // when
        WebTestClient.ResponseSpec response =
                hermes.api().unblacklistTopicResponse(topic.getQualifiedName());
    ...
    public void shouldReportValidStatusOfTopic() {
        ...
        // then
        assertThat(hermes.api().isTopicBlacklisted(topic.getQualifiedName()))
