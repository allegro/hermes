...
public class PublishingTest {
    ...
    public void shouldReturn429ForQuotaViolation() {
        ...
        hermes.api().publishUntilStatus(topic.getQualifiedName(), message.body(), HttpStatus.TOO_MANY_REQUESTS.value());
    }
    ...
    public void shouldReturn4xxForTooLargeContent() {
        ...
        // when
        WebTestClient.ResponseSpec response = hermes.api().publish(topic.getQualifiedName(), StringUtils.repeat("X", 2555));
