...
public class KafkaRetransmissionServiceTest {
    ...
    public void shouldMoveOffsetInDryRunMode() throws InterruptedException {
        ...
        MultiDCOffsetChangeSummary summary =
                response.expectBody(MultiDCOffsetChangeSummary.class)
                        .returnResult()
                        .getResponseBody();
        ...
        Long offsetSum =
                summary
                        ...
                        .get(PRIMARY_KAFKA_CLUSTER_NAME)
                        .stream()
    ...
    public void shouldMoveOffsetInDryRunModeForTopicsMigratedToAvro() throws InterruptedException {
        ...
        PartitionOffsetsPerKafkaTopic offsets =
                PartitionOffsetsPerKafkaTopic.from(
                        summary.getPartitionOffsetListPerBrokerName()
                                .get(PRIMARY_KAFKA_CLUSTER_NAME));
        assertThat(
                        (Long)
                                offsets.jsonPartitionOffsets.stream()
                                        .mapToLong(PartitionOffset::getOffset)
                                        .sum())
                .isEqualTo(1);
        assertThat(
                        (Long)
                                offsets.avroPartitionOffsets.stream()
                                        .mapToLong(PartitionOffset::getOffset)
                                        .sum())
                .isEqualTo(0);
    }
