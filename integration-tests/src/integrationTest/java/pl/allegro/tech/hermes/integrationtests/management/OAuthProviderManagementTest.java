...
public class OAuthProviderManagementTest {
    ...
    public void shouldCreateOAuthProvider() {
        ...
        OAuthProvider createdProvider = hermes.api().getOAuthProvider(oAuthProvider.getName())
                .expectStatus().isOk()
                .expectBody(OAuthProvider.class).returnResult().getResponseBody();
    ...
    public void shouldNotAllowCreatingTheSameOAuthProviderTwice() {
        ...
        // then
        ErrorDescription error = secondTryResponse
    ...
    public void shouldUpdateOAuthProvider() {
        ...
        OAuthProvider updatedProvider = hermes.api().getOAuthProvider(oAuthProvider.getName())
                .expectStatus().isOk()
                .expectBody(OAuthProvider.class).returnResult().getResponseBody();
    ...
    public void shouldRemoveOAuthProvider() {
        ...
        hermes.api().listOAuthProvider()
                .expectStatus().isOk()
                .expectBodyList(String.class).doesNotContain(oAuthProvider.getName());
    }
}
