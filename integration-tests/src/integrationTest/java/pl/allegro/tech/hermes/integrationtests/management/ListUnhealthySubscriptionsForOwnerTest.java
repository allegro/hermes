...
public class ListUnhealthySubscriptionsForOwnerTest {
    ...
    public void shouldNotListHealthySubscriptions() {
        ...
        prometheus.stubSubscriptionMetrics(
                subscriptionMetrics(healthySubscription.getQualifiedName())
                        .withRate(100)
                        .build()
        );

        // when / then
        hermes.api().listUnhealthyForOwner("Team A")
                .expectStatus()
                .isOk()
                .expectBodyList(UnhealthySubscription.class)
                .hasSize(0);
        hermes.api().listUnhealthyForOwnerAsPlainText("Team A")
                .expectStatus()
                .isOk()
                .expectBody()
                .isEmpty();
    ...
    public void shouldReturnOnlyUnhealthySubscriptionOfSingleOwner() {
        ...
        hermes.api().listUnhealthyForOwnerAsPlainText("Team A")
                ...
                .isEqualTo("%s - Consuming service returns a lot of 5xx codes for subscription %s, currently 11 5xx/s"
                        .formatted(unhealthySubscription.getName(), unhealthySubscription.getQualifiedName().toString())
                );
    }
    ...
    public void shouldReportAllUnhealthySubscriptions() {
        ...
        // when / then
        hermes.api().listUnhealthy()
                .expectStatus()
                .isOk()
                .expectBodyList(UnhealthySubscription.class)
                .contains(malfunctioningSubscription(unhealthySubscription, 11));
        hermes.api().listUnhealthyAsPlainText()
                .expectStatus()
                .isOk()
                .expectBody(String.class)
                .isEqualTo("%s - Consuming service returns a lot of 5xx codes for subscription %s, currently 11 5xx/s"
    ...
    public void shouldReturnUnhealthySubscriptionsFilteredByTopic() {
        ...
        prometheus.stubTopicMetrics(
                topicMetrics(topic1.getName())
                        .withRate(100)
                        .withDeliveryRate(50)
                        .build()
        );
        prometheus.stubTopicMetrics(
                topicMetrics(topic2.getName())
                        .withRate(100)
                        .withDeliveryRate(50)
                        .build()
        );
        ...
        // when / then
        hermes.api().listUnhealthyForTopic(topic2.getQualifiedName())
                .expectStatus()
                .isOk()
                .expectBodyList(UnhealthySubscription.class)
                .contains(malfunctioningSubscription(unhealthySubscriptionTopic2, 11));
        hermes.api().listUnhealthyForTopicAsPlainText(topic2.getQualifiedName())
                .expectStatus()
                .isOk()
                .expectBody(String.class)
                .isEqualTo("%s - Consuming service returns a lot of 5xx codes for subscription %s, currently 11 5xx/s"
                        .formatted(unhealthySubscriptionTopic2.getName(), unhealthySubscriptionTopic2.getQualifiedName().toString())
                );
    }
    ...
    public void shouldReturnSpecificUnhealthySubscription() {
        ...
        // when / then
        hermes.api().listUnhealthyForSubscription(topic.getQualifiedName(), healthySubscription.getName())
                .expectStatus()
                .isOk()
                .expectBodyList(UnhealthySubscription.class)
                .hasSize(0);
        hermes.api().listUnhealthyForSubscriptionAsPlainText(topic.getQualifiedName(), healthySubscription.getName())
                .expectStatus()
                .isOk()
                .expectBody()
                .isEmpty();
        hermes.api().listUnhealthyForSubscription(topic.getQualifiedName(), unhealthySubscription.getName())
                .expectStatus()
                .isOk()
                .expectBodyList(UnhealthySubscription.class)
                .contains(malfunctioningSubscription(unhealthySubscription, 11));
        hermes.api().listUnhealthyForSubscriptionAsPlainText(topic.getQualifiedName(), unhealthySubscription.getName())
                .expectStatus()
                .isOk()
                .expectBody(String.class)
                .isEqualTo("%s - Consuming service returns a lot of 5xx codes for subscription %s, currently 11 5xx/s"
    ...
    public void shouldReportUnhealthySubscriptionsDisrespectingSeverity() {
        ...
        prometheus.stubSubscriptionMetrics(
                subscriptionMetrics(subscription3.getQualifiedName())
                        .withRate(50)
                        .with500Rate(11)
                        .build()
        );
    ...
    private Subscription createSubscriptionOwnedBy(String ownerId, Topic topic, Severity severity) {
        return hermes.initHelper().createSubscription(
    ...
    private static UnhealthySubscription malfunctioningSubscription(Subscription subscription, double code5xxErrorsRate) {
