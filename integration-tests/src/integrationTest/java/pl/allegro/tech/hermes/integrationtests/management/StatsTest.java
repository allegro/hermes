...
public class StatsTest {
    ...
    public void shouldGetStats() {
        ...
        TopicWithSchema topic1 =
                topicWithSchema(topic(Topic.Ack.ALL, ContentType.AVRO, true), SCHEMA);
        ...
        assertThat(stats.getSubscriptionStats().getTrackingEnabledSubscriptionCount())
                .isEqualTo(
                        initalStats.getSubscriptionStats().getTrackingEnabledSubscriptionCount()
                                + 1);
