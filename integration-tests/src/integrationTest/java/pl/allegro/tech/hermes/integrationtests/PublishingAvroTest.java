...
public class PublishingAvroTest {
    ...
    public void shouldSendAvroAfterSubscriptionContentTypeChanged() {
        ...
        hermes.api()
                .updateSubscription(
                        topic,
                        "subscription",
                        patchData().set("contentType", ContentType.AVRO).build());
    ...
    public void shouldGetBadRequestForJsonNotMatchingWithAvroSchemaAndAvroContentType() {
        ...
        Topic topic = hermes.initHelper().createTopicWithSchema(topicWithSchema);
        String message =
                "{\"__metadata\":null,\"name\":\"john\",\"age\":\"string instead of int\"}";
    ...
    public void shouldReturnBadRequestOnMissingSchemaAtSpecifiedVersion() {
        ...
        HermesMessage message =
                hermesMessage(topic.getQualifiedName(), user.asBytes()).avro(2).build();
    ...
    public void shouldUseExplicitSchemaVersionWhenPublishingAndConsuming() {
        ...
        // when
        HermesMessage message =
                hermesMessage(topic.getQualifiedName(), user.asBytes()).avro(1).build();
        ...
        subscriber.waitUntilRequestReceived(
                request -> {
                    assertThat(
                                    request.getHeaders()
                                            .getHeader(HermesMessage.SCHEMA_VERSION_HEADER)
                                            .firstValue())
                            .isEqualTo("1");
    ...
    public void shouldUpdateSchemaAndUseItImmediately() {
        ...
        hermes.api()
                .publishAvroUntilSuccess(
                        topic.getQualifiedName(),
                        messageV2.getBody(),
                        createHeaders(messageV2.getHeaders()));
                        ...
                        () -> {
                            ContentType actual =
                                    hermes.api()
                                            ...
                                            .getContentType();
                            logger.info(
                                    "Expecting {} subscription endpoint address. Actual {}",
                                    expected,
                                    actual);
