...
public class FrontendConfigurationProperties {
    ...
    public static String FRONTEND_READINESS_CHECK_KAFKA_CHECK_ENABLED =
            "frontend.readiness.check.kafkaCheckEnabled";
    public static String FRONTEND_READINESS_CHECK_INTERVAL_SECONDS =
            "frontend.readiness.check.interval";
    public static String FRONTEND_AUTHENTICATION_MODE = "frontend.handlers.authentication.mode";
    public static String FRONTEND_AUTHENTICATION_ENABLED =
            "frontend.handlers.authentication.enabled";
    public static String FRONTEND_KEEP_ALIVE_HEADER_ENABLED =
            "frontend.handlers.keepAliveHeader.enabled";
    public static String FRONTEND_KEEP_ALIVE_HEADER_TIMEOUT =
            "frontend.handlers.keepAliveHeader.timeout";
    public static String FRONTEND_IDLE_TIMEOUT = "frontend.handlers.idleTimeout";
    public static String METRICS_MICROMETER_REPORT_PERIOD =
            "frontend.metrics.micrometer.reportPeriod";
    ...
    public static String FRONTEND_FORCE_TOPIC_MAX_MESSAGE_SIZE =
            "frontend.handlers.forceTopicMaxMessageSize";
    public static String FRONTEND_HTTP2_ENABLED = "frontend.server.http2Enabled";
    public static String FRONTEND_GRACEFUL_SHUTDOWN_ENABLED =
            "frontend.server.gracefulShutdownEnabled";
    public static String FRONTEND_PORT = "frontend.server.port";
    public static String ZOOKEEPER_CONNECTION_STRING =
            "frontend.zookeeper.clusters.[0].connectionString";
    ...
    public static String FRONTEND_HEADER_PROPAGATION_ENABLED =
            "frontend.http.headers.propagationEnabled";
